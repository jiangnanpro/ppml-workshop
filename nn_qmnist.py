...
with open(os.path.join(current_dir,'y_defender.pickle'), 'rb') as f:
    y_defender = pkl.load(f)
  
with open(os.path.join(current_dir,'y_reserve.pickle'), 'rb') as f:
...
best_test = 0.80 # value of best test_accuracy
